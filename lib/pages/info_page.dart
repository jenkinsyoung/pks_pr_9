...
import 'package:pr_9/components/info_ui.dart';
import 'package:pr_9/models/item.dart';
import 'package:pr_9/pages/edit_game_page.dart';
import 'package:pr_9/server_api/server_api.dart';
...
class _InfoPageState extends State<InfoPage> {
  ...
  Future<void> _updateGameInfo(Item game) async {
    try {
      setState(() {
        ApiService().updateGameInfo(widget.game.id, game);
      });
    } catch (e) {
      print("Error updating favorite status: $e");
    }
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    ...
                    onTap: () async {
                      ...
                      context,
                      MaterialPageRoute(builder: (context) => EditGamePage(game: widget.game)),
                      );
